...
const cards = [
  {
    icon: "/3dicons-crown-dynamic-color.png",
    title: "AI First",
  ...
  {
    icon: "/3dicons-target-dynamic-color.png",
    title: "Accurate",
    desc: "94% accuracy rate validated across thousands of real-world screenings.",
  },
  {
    icon: "/3dicons-lock-dynamic-color.png",
    title: "Secure",
    desc: "End-to-End encryption on all uploaded files.",
  },
];
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
          <div>
            ...
            <p className="text-gray-500 dark:text-gray-400 leading-relaxed mb-5">
              ...
              spent weeks reviewing hundreds of CVs for a single role, missing
              great candidates because of sheer volume. I knew there had to be a
              better way.
            </p>
            <p className="text-gray-500 dark:text-gray-400 leading-relaxed mb-8">
              RecruitBot can hire faster, fairer, and smarter — powered by
          ...
          <div className="grid grid-cols-2 gap-4">
            {cards.map((card, i) => (
              ...
              >
                ...
                <div className="h-12 w-12 mb-3 flex items-center justify-start">
                  {card.icon ? (
                    <img
                      src={card.icon}
                      alt={`${card.title} icon`}
                      className="w-full h-full object-contain animate-[float_4s_ease-in-out_infinite] transition-transform duration-300 hover:scale-110"
                    />
                  ) : (
